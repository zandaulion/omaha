...
/** One glossary entry: what it means, why it matters, how it is computed. */
...
/**
 * `explain(key)` mirrors core/glossary.js's own: a direct hit in the
 * entries, falling back through the alias table, or null. Callers pass
 * whichever key or alias reads naturally at the call site — see
 * ExplainSheet.kt's ExplainableLabel.
 */
object Glossary {
    private val ENTRIES: Map<String, GlossaryEntry> = mapOf(
        "health-score" to GlossaryEntry(
            title = "Health score",
            ...
            computes = "Each pillar is scored out of 20 and the five are added. Within a pillar, the score is rescaled over the items that could actually be measured. A measure the filings do not contain is reported as unavailable and dropped from its pillar, so it neither helps nor hurts. It is never assumed to be zero. If too little of the scorecard can be measured at all, no composite is published rather than a confident number resting on three inputs."
        ),
        "Financial Health & Solvency" to GlossaryEntry(
        ...
        "Profitability & Moat Quality" to GlossaryEntry(
        ...
        "Valuation & Margin of Safety" to GlossaryEntry(
        ...
        "Growth & Operating Leverage" to GlossaryEntry(
        ...
        "Capital Allocation & Returns" to GlossaryEntry(
        ...
        "Altman Z-Score" to GlossaryEntry(
        ...
        "Equity to assets" to GlossaryEntry(
        ...
        "Net debt / EBITDA" to GlossaryEntry(
        ...
        "Interest coverage" to GlossaryEntry(
        ...
        "Current & quick ratio" to GlossaryEntry(
        ...
        "Debt to Equity" to GlossaryEntry(
        ...
        "Piotroski F-Score" to GlossaryEntry(
            ...
            computes = "Scored over the tests that can actually be evaluated and reported as a fraction of those, so a company missing one input is not marked down for the gap. A measure the filings do not contain is reported as unavailable and dropped from its pillar, so it neither helps nor hurts. It is never assumed to be zero."
        ),
        "Return on invested capital" to GlossaryEntry(
        ...
        "Return on equity" to GlossaryEntry(
        ...
        "Free cash flow conversion" to GlossaryEntry(
        ...
        "Operating margin trend" to GlossaryEntry(
        ...
        "ROIC vs. Cost of Capital" to GlossaryEntry(
        ...
        "Gross Margin Consistency" to GlossaryEntry(
        ...
        "Free Cash Flow History" to GlossaryEntry(
        ...
        "Diluted EPS CAGR" to GlossaryEntry(
        ...
        "FCF per share CAGR" to GlossaryEntry(
        ...
        "Gross margin trajectory" to GlossaryEntry(
        ...
        "Forward P/E vs. own history" to GlossaryEntry(
        ...
        "EV / free cash flow yield" to GlossaryEntry(
        ...
        "Discount to fair value" to GlossaryEntry(
        ...
        "Estimated Fair Value" to GlossaryEntry(
        ...
        "Current Price" to GlossaryEntry(
            title = "Current price",
        ...
        "Buybacks vs. dilution" to GlossaryEntry(
        ...
        "Dividend safety & coverage" to GlossaryEntry(
        ...
        "Reinvestment quality" to GlossaryEntry(
        ...
        "Asset turnover efficiency" to GlossaryEntry(
        ...
        "Share count YoY" to GlossaryEntry(
        ...
        "Dividend yield" to GlossaryEntry(
        ...
        "Operating margin" to GlossaryEntry(
        ...
        "P/E vs 5y median" to GlossaryEntry(
        ...
        "Checklist passed" to GlossaryEntry(
        ...
        "dcf-terminal-multiple" to GlossaryEntry(
        ...
        "dcf-discount-rate" to GlossaryEntry(
        ...
        "justified-ptbv" to GlossaryEntry(
            ...
            computes = "(return on tangible equity − growth) ÷ (cost of equity − growth). Gordon growth divides one small difference by another, so when the return sits near the growth rate a modest change in either moves the answer a long way — which is why the best-year and worst-year values are published beside it."
        ),
        "margin-of-safety" to GlossaryEntry(
        ...
        "implied-growth" to GlossaryEntry(
        ...
        "earnings-power" to GlossaryEntry(
        ...
        "cost-of-equity" to GlossaryEntry(
    ...
    private val ALIASES: Map<String, String> = mapOf(
        "Health score" to "health-score",
        "Cash conversion" to "Free cash flow conversion",
        "Net cash / (debt)" to "Net Cash",
        "Current ratio" to "Current & quick ratio",
        "Solvency" to "Financial Health & Solvency",
        "Profitability" to "Profitability & Moat Quality",
        "Valuation" to "Valuation & Margin of Safety",
        "Growth" to "Growth & Operating Leverage",
        "Capital Return" to "Capital Allocation & Returns",
        "Capital" to "Capital Allocation & Returns",
        "ROIC" to "Return on invested capital",
        "ROIC − WACC" to "ROIC vs. Cost of Capital",
        "FCF conversion" to "Free cash flow conversion",
        "Equity / assets" to "Equity to assets",
        "Net cash" to "Net Cash",
        "Trailing P/E" to "P/E Ratio",
        "Interest Coverage" to "Interest coverage",
        "Current Ratio" to "Current & quick ratio",
        "FCF / Net Income Quality" to "Free cash flow conversion",
        "Valuation PEG Ratio" to "PEG ratio",
        "Revenue Growth" to "Revenue CAGR",
        "Share Dilution & Buybacks" to "Buybacks vs. dilution",
    )

    fun explain(key: String?): GlossaryEntry? {
        if (key == null) return null
        return ENTRIES[key] ?: ALIASES[key]?.let { ENTRIES[it] }
    }
}

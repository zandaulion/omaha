...
function renderGeminiDashboard(data) {
  ...
  container.innerHTML = `
    <!-- 1. AI Verdict Hero Card.
         ...
         only in the footer is one they reach after believing it. -->
    <div class="card card-elevated ai-verdict-card" style="margin-bottom: 16px;">
      ...
      <div class="ai-origin-tag" style="margin-bottom: 10px;">✨ AI-generated</div>
      ...
      <p class="disclaimer-note">
        Written by a language model from this company's filed figures. It can be
        wrong, confidently and in detail — treat it as a second reading, not a
        verdict. Not investment advice.
      </p>
    </div>
